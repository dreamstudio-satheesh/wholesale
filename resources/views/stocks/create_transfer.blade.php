    ...
    <div class="content">
        <div class="row">
            <div class="col-lg-12">
                ...
                <form id="stocktransferForm" action="" method="POST">
                    <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        @if ($moduleStatuses['warehouses'])
                                            <div class="form-group col-md-6">
                                                ...
                                                <select id="warehouseSelect" class="form-control" required>
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <div class="input-group">
                                                    <select id="warehouseTo" class="form-control" required>
                                                        <option value=''>Select Warhouse</option>
                                                        @foreach ($warehouses as $warehouse)
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <input type="datetime-local"
                                            value="{{ \Carbon\Carbon::now()->format('Y-m-d\TH:i') }}" name="inv_datetime"
                                            class="form-control">
                                    </div>
...
@push('scripts')
    <script>
        var StockTransferURL = "{{ route('stocks.create.transfer') }}";
    ...
    <script src="{{ assets('assets/js/create_stock_transfer.js') }}"></script>
@endpush
